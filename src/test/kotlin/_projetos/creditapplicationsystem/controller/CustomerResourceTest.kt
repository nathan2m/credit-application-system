...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Manera"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("nathan@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("00000-000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua do Nathan"))
    ...
    fun `should not find customer with invalid id and return 400 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.exception")
                    .value("class _projetos.creditapplicationsystem.exception.BusinessException")
            )
            .andExpect(MockMvcResultMatchers.jsonPath("$.details[*]").isNotEmpty)
            .andDo(MockMvcResultHandlers.print())
    }
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("NathanUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("ManeraUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("nathan@email.com"))
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "NathanUpdate",
        lastName: String = "ManeraUpdate",
